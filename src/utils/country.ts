...
/**
 * Resolves country name to 2-letter ISO code.
 */
export function getCountryCode(countryName: string): string {
  const normalized = countryName.toLowerCase().trim();
  return COUNTRY_NAME_TO_CODE[normalized] || 'US'; // US fallback
}

/**
 * Builds FlagCDN URL for country code.
 */
export function getFlagUrl(countryCode: string): string {
  ...
  return `https://flagcdn.com/w160/${shortCode}.png`;
}
